      ...
      <footer className="bg-surface-container-low border-t border-accent/60 py-12 mt-auto">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col gap-2">
            <span className="font-script text-2xl text-primary font-bold">SkillBounty</span>
            <p className="text-xs text-charcoal/50">© 2026 SkillBounty. Built on Stellar + Soroban. All rights reserved.</p>
          </div>
